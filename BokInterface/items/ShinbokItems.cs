...
namespace BokInterface.Items {
    ...
    class ShinbokItems {
        ...
        private void InitItems() {
            ...
            Items.Add("Tasty Meat", new ShinbokItem("Tasty Meat", 4, "tasty_meat", true));
            Items.Add("Rotten Meat", new ShinbokItem("Rotten Meat", 5, "rotten_meat"));
            Items.Add("Chocolate", new ShinbokItem("Chocolate", 6, "chocolate", true));
            ...
            Items.Add("GariGari Soda", new ShinbokItem("GariGari Soda", 10, "garigari_soda", true));
            Items.Add("GariGari Cola", new ShinbokItem("GariGari Cola", 11, "garigari_cola", true));
            Items.Add("Magical Potion", new ShinbokItem("Magical Potion", 12, "magical_potion"));
            Items.Add("Solar Nut", new ShinbokItem("Solar Nut", 13, "solar_nut", true));
            ...
            Items.Add("Bearnut", new ShinbokItem("Bearnut", 18, "bearnut", true));
            Items.Add("Speed Nut", new ShinbokItem("Speed Nut", 19, "speed_nut", true));
            Items.Add("Banana", new ShinbokItem("Banana", 20, "banana", true));
            Items.Add("Chocolate Banana", new ShinbokItem("Chocolate Banana", 21, "chocolate_banana"));
            Items.Add("Tiptoe Nut", new ShinbokItem("Tiptoe Nut", 22, "tiptoe_nut", true));
            Items.Add("Redshroom", new ShinbokItem("Redshroom", 23, "redshroom", true));
            Items.Add("Blueshroom", new ShinbokItem("Blueshroom", 24, "blueshroom", true));
            Items.Add("See-All Nut", new ShinbokItem("See-All Nut", 25, "see_all_nut", true));
