namespace BokInterface.Items {
    ...
    class DsItem : Item {
        ...
        public DsItem(string name, uint value, string icon = "", string effect = "", bool perishable = false, int durability = 0, Item? coveredItem = null, int buyPrice = 0) : base(name, value, icon, effect, perishable, durability, coveredItem, buyPrice) {
