...
namespace BokInterface.Items {
    ...
    class DsItems {
        ...
        private void InitItems() {
            ...
            Items.Add("Earth Fruit", new DsItem("Earth Fruit", 3, "earth_fruit", true));
            Items.Add("Delicious Meat", new DsItem("Delicious Meat", 4, "delicious_meat", true));
            ...
            Items.Add("Solar Fruit", new DsItem("Solar Fruit", 11, "solar_fruit", true));
            Items.Add("Magical Ice Pop", new DsItem("Magical Ice Pop", 12, "magical_ice_pop", true));
            Items.Add("Magical Drink", new DsItem("Magical Drink", 13, "magical_drink", true));
            ...
            Items.Add("Chocolate", new DsItem("Chocolate", 20, "chocolate", true));
            ...
            Items.Add("Milk", new DsItem("Milk", 30, "milk", true));
            ...
            Items.Add("Clairvoyance Fruit", new DsItem("Clairvoyance Fruit", 35, "clairvoyance_fruit", true));
            Items.Add("Speed Fruit", new DsItem("Speed Fruit", 36, "speed_fruit", true));
            Items.Add("Stealth Fruit", new DsItem("Stealth Fruit", 37, "stealth_fruit", true));
            Items.Add("Power Fruit", new DsItem("Power Fruit", 38, "power_fruit", true));
            Items.Add("Chocolate Banana", new DsItem("Chocolate Banana", 39, "chocolate_banana"));
            Items.Add("Endurance Fruit", new DsItem("Endurance Fruit", 40, "endurance_fruit", true));
