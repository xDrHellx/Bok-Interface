    ...
    class MemoryValues {
        ...
        private void InitializeShinbokList() {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                Inventory.Add("slot" + slotNumber + "_weapon", new DynamicMemoryValue("slot" + slotNumber + "_weapon", _shinbokAddresses.Misc["stat"].Address, _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_bonus"].Address, type: _shinbokAddresses.Inventory["weapon_slot_" + slotNumber].Type));
                Inventory.Add("slot" + slotNumber + "_weapon_durability", new DynamicMemoryValue("slot" + slotNumber + "_weapon_durability", _shinbokAddresses.Misc["stat"].Address, _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_durability"].Address, type: _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_bonus"].Type));

                Inventory.Add("slot" + slotNumber + "_weapon_sp_ability_1", new DynamicMemoryValue("slot" + slotNumber + "_weapon_sp_ability_1", _shinbokAddresses.Misc["stat"].Address, _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_sp_ability_1"].Address, type: _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_bonus"].Type));
                Inventory.Add("slot" + slotNumber + "_weapon_sp_ability_2", new DynamicMemoryValue("slot" + slotNumber + "_weapon_sp_ability_2", _shinbokAddresses.Misc["stat"].Address, _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_sp_ability_2"].Address, type: _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_bonus"].Type));

                Inventory.Add("slot" + slotNumber + "_weapon_refine", new DynamicMemoryValue("slot" + slotNumber + "_weapon_refine", _shinbokAddresses.Misc["stat"].Address, _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_refine"].Address, type: _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_bonus"].Type));
                Inventory.Add("slot" + slotNumber + "_weapon_pattern", new DynamicMemoryValue("slot" + slotNumber + "_weapon_pattern", _shinbokAddresses.Misc["stat"].Address, _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_pattern"].Address, type: _shinbokAddresses.Inventory["weapon_slot_" + slotNumber + "_bonus"].Type));
            }
        }
