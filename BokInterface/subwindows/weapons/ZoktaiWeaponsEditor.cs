    ...
    class ZoktaiWeaponsEditor : WeaponsEditor {
        ...
        protected override void SetValues() {
            ...
            for (int i = 0; i < slots.Count; i++) {
                ...
                APIs.Gui.AddMessage(i.ToString() + " => " + slots[i].Enabled.ToString());
                /**
        ...
        private void SetMemoryValue(string subList, string valueKey, decimal value) {
            ...
            switch (subList) {
                ...
                case "inventory":
                    ...
                    // Set the "Forged by" name to "TaiyohNetwrk"
                    if (keyParts[0].Length >= 6) {
                        SetWeaponForgedByName(Convert.ToInt32(keyParts[0].Substring(4, 2)));
                    }
        ...
        private void SetWeaponForgedByName(int slot) {
            if (slot > 0 && slot < 17) {
                // APIs.Gui.AddMessage(slot.ToString());
