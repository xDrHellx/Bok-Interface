...
namespace BokInterface {
    partial class BokInterfaceMainForm {
        ...
        private GroupBox _edit_skillGroupBox = new();
        ...
        private void ZoktaiStatusEditSubwindow() {
            ...
            _edit_skillGroupBox = CreateGroupBox("editSkillGroup", "Skill", 114, 5, 220, 105);
            _edit_statsGroupBox = CreateGroupBox("editStatsGroup", "Stats", 340, 5, 84, 134);
            ...
            // Status
            _edit_statusLabels.Add(CreateLabel("djangoEditLevelLabel", "Level", 7, 19, 34, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditHpLabel", "LIFE :", 7, 47, 34, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditEneLabel", "ENE :", 7, 81, 34, 15));

            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_level", defaultValues["django_level"], 47, 16, 50, 23));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_current_hp", defaultValues["django_current_hp"], 47, 45, 50, 23, maxValue: 1000));
            ...
            // Skill
            _edit_statusLabels.Add(CreateLabel("djangoEditSwordSkillLabel", "Sword", 8, 19, 54, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditSpearSkillLabel", "Spear", 121, 19, 36, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditHammerSkillLabel", "Hammer", 8, 47, 54, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditFistsSkillLabel", "Fists", 121, 47, 36, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditGunSkillLabel", "Gun", 8, 76, 54, 15));

            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_sword_skill", defaultValues["django_sword_skill"], 64, 16, 51, 23, nbDecimals: 2));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_spear_skill", defaultValues["django_spear_skill"], 163, 16, 51, 23, nbDecimals: 2));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_hammer_skill", defaultValues["django_hammer_skill"], 64, 45, 51, 23, nbDecimals: 2));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_fists_skill", defaultValues["django_fists_skill"], 163, 45, 51, 23, nbDecimals: 2));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_gun_skill", defaultValues["django_gun_skill"], 64, 74, 51, 23, nbDecimals: 2));
            ...
            // Stats
            _edit_statusLabels.Add(CreateLabel("djangoEditVitLabel", "VIT", 8, 19, 27, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditSprLabel", "SPR", 8, 47, 27, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditStrLabel", "STR", 8, 76, 27, 15));
            _edit_statusLabels.Add(CreateLabel("djangoEditAgiLabel", "AGI", 8, 105, 27, 15));

            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_vit", defaultValues["django_vit"], 36, 16, 41, 23));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_spr", defaultValues["django_spr"], 36, 45, 41, 23));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_str", defaultValues["django_str"], 36, 74, 41, 23));
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_agi", defaultValues["django_agi"], 36, 105, 41, 23));
        ...
        private IDictionary<string, decimal> GetZoktaiDefaultValues() {
            ...
            if (stat > 0) {
                ...
                defaultValues.Add("django_vit", _memoryValues.U16["vit"].Value);
                defaultValues.Add("django_spr", _memoryValues.U16["spr"].Value);
                defaultValues.Add("django_str", _memoryValues.U16["str"].Value);
                defaultValues.Add("django_agi", _memoryValues.U16["agi"].Value);
