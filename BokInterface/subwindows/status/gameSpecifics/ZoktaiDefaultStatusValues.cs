...
namespace BokInterface {
    partial class BokInterfaceMainForm {
        ...
        private void ZoktaiStatusEditSubwindow() {
            ...
            // Sections
            _edit_statusGroupBox = CreateGroupBox("editStatusGroup", "Status", 5, 5, 103, 76);
            ...
            _edit_statusLabels.Add(CreateLabel("djangoEditEneLabel", "ENE :", 7, 47, 34, 15));
            ...
            _edit_statusNumericUpDowns.Add(CreateNumericUpDown("django_current_ene", defaultValues["django_current_ene"], 47, 45, 50, 23, maxValue: 1000));
