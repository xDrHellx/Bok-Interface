...
class ShinbokWeapons {
    ...
    private void InitFencingSwords() {
        ...
        FencingSwords.Add("Blue Rose", new ShinbokWeapon("Blue Rose", 40, type, "blue_rose", level: 55, baseDamage: 60, attackPatterns: ["P1,P2,P3,P4------H6", "P1,P2,P3,H4------V6", "P1,P2,H3,V4------P4"]));
    ...
    private void InitCurvedSwords() {
        ...
        CurvedSwords.Add("Falchion", new ShinbokWeapon("Falchion", 17, type, "falchion", level: 25, baseDamage: 30, attackPatterns: ["H2,H3------V6", "H2,H3------V6,H6", "H2,H3--H6------V6"]));
        ...
        CurvedSwords.Add("Kora", new ShinbokWeapon("Kora", 27, type, "kora", level: 40, baseDamage: 45, attackPatterns: ["H2,H3------V6", "H2,H3--H6------V6", "H2,H3--H4----H4------V6"]));
        CurvedSwords.Add("Ice Edge", new ShinbokWeapon("Ice Edge", 31, type, "ice_edge", level: 45, baseDamage: 50, attackPatterns: ["H2--H3----H4------H6", "H2--H3----H4------H4", "H2,H3--H6----H6------V6"]));
        CurvedSwords.Add("Damascus Edge", new ShinbokWeapon("Damascus Edge", 35, type, "damascus_edge", level: 50, baseDamage: 55, attackPatterns: ["H2--H3----H4------H4", "H2,H3--H6----H6------V6", "H2,H3,H4--H4----V6"]));
        CurvedSwords.Add("Thunder Edge", new ShinbokWeapon("Thunder Edge", 41, type, "thunder_edge", level: 55, baseDamage: 60, attackPatterns: ["H2,H3--H6----H6------V6", "H2,H3,H4--H4----V6", "H2,H3,H4--V4----H6"]));
    }
    ...
    private void InitKatanas() {
        ...
        Katanas.Add("Ohka (Sakurabana)", new ShinbokWeapon("Ohka (Sakurabana)", 28, type, "sakurabana", level: 40, baseDamage: 45, attackPatterns: ["V2,H3,V3--P4", "V2,H3,H3,H4,V4", "V2,H3--H3,V4--P4"]));
    ...
    private void InitLongSwords() {
        ...
        LongSwords.Add("Iron Blade", new ShinbokWeapon("Iron Blade", 15, type, "iron_blade", level: 20, baseDamage: 25, attackPatterns: ["H2--V2----P6", "H2----H2--V4", "H2--V2----H4"]));
        LongSwords.Add("Schiavona", new ShinbokWeapon("Schiavona", 22, type, "schiavona", level: 30, baseDamage: 35, attackPatterns: ["H2----H2--V4", "H2--V2----H4", "H2--H2--V4----P6"]));
        LongSwords.Add("Bastard Sword", new ShinbokWeapon("Bastard Sword", 25, type, "bastard_sword", level: 35, baseDamage: 40, attackPatterns: ["H2--V2----H4", "H2--H2--V4----P6", "H2,H2--V4----H4"]));
        ...
        LongSwords.Add("Fire Blade", new ShinbokWeapon("Fire Blade", 43, type, "fire_blade", level: 55, baseDamage: 60, attackPatterns: ["H2,V2----H4--V4", "H2,V2----H4----H4----P6", "H2,V2----P4----H4----V6"]));
