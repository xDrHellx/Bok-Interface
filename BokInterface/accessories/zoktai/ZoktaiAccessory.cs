namespace BokInterface.Accessories {
    ...
    class ZoktaiAccessory(string name, uint value, string icon = "", string effect = "", int row = 1, int buyPrice = 0, bool crossOver = false, int defense = 0, int weight = 0) : Accessory(name, value, "body", icon, effect, row, buyPrice, crossOver) {
