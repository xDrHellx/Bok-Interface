...
namespace BokInterface.Addresses {
    ...
    public class BoktaiAddresses {
        ...
        public BoktaiAddresses() {
            ...
            // Add Misc addresses
            Misc.Add("boss_hp", new MemoryAddress(0x02001B5E, domain: "EWRAM"));
            Misc.Add("trap_hp", new MemoryAddress(0x02001B6A, domain: "EWRAM"));
            ...
            Misc.Add("permafrost_ceiling", new MemoryAddress(0x02007542, domain: "EWRAM"));
            Misc.Add("piledriver_top_left", new MemoryAddress(0x02008436, domain: "EWRAM"));
            Misc.Add("piledriver_top_right", new MemoryAddress(0x02008956, domain: "EWRAM"));
            Misc.Add("piledriver_bottom_left", new MemoryAddress(0x02008BE6, domain: "EWRAM"));
            Misc.Add("piledriver_bottom_right", new MemoryAddress(0x020086C6, domain: "EWRAM"));
